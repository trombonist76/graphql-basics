...
import { GraphQLServerInject, YogaInitialContext, FetchAPI } from './types.cjs';
import { Plugin } from './plugins/types.cjs';
import { YogaLogger } from './logger.cjs';
import { CORSPluginOptions } from './plugins/useCORS.cjs';
import { GraphiQLOptions, GraphiQLOptionsOrFactory } from './plugins/useGraphiQL.cjs';
...
export declare type YogaServerInstance<TServerContext, TUserContext, TRootValue> = YogaServer<TServerContext, TUserContext, TRootValue> & (WindowOrWorkerGlobalScope['fetch'] | ((request: Request, serverContext?: TServerContext) => Promise<Response>) | ((context: {
    request: Request;
}) => Promise<Response>));
